...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
    {{-- Header --}}
    <div class="mb-8">
        <p class="text-hearth-500 text-sm font-semibold uppercase tracking-wider mb-2">Explore</p>
        <h1 class="font-serif text-3xl md:text-4xl font-bold text-hearth-800">Discover Cafes</h1>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-4 mb-8">
        <form action="{{ route('discover') }}" method="GET" class="flex-1 flex gap-3">
            <div class="flex-1 relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search cafes by name, location..."
    ...
    @else
        <div class="text-center py-20">
            ...
            <h3 class="font-serif text-xl font-semibold text-hearth-800 mb-2">No cafes found</h3>
            <p class="text-hearth-400">Try adjusting your search or filters.</p>
        </div>
    @endif
</section>
@endsection
