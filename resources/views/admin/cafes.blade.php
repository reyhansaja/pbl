...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <h1 class="font-serif text-3xl font-bold text-hearth-800">{{ __('Manage Cafes') }}</h1>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-hearth-50 border-b border-hearth-100">
                    <tr>
                        <th class="text-left py-3 px-4 text-xs font-semibold text-hearth-400 uppercase tracking-wider">{{ __('Cafe') }}</th>
                        <th class="text-left py-3 px-4 text-xs font-semibold text-hearth-400 uppercase tracking-wider">{{ __('Owner') }}</th>
