...
<section class="relative overflow-hidden bg-hearth-800 text-white">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
        <div class="max-w-2xl">
            <p class="text-accent text-sm font-semibold uppercase tracking-widest mb-4 fade-in">Welcome to The Hearth</p>
            <h1 class="font-serif text-4xl md:text-6xl font-bold leading-tight mb-6 fade-in">
                Discover Cafes, <br>
                <span class="text-accent">Handcrafted</span> for You
            </h1>
            <p class="text-hearth-200 text-lg leading-relaxed mb-8 max-w-lg fade-in">
                Gather round the digital table for a more intentional discovery experience. Every corner has a story.
            </p>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
    <div class="flex items-end justify-between mb-10">
        <div>
            <p class="text-hearth-500 text-sm font-semibold uppercase tracking-wider mb-2">Curated Selection</p>
            <h2 class="font-serif text-3xl md:text-4xl font-bold text-hearth-800">Popular Cafes</h2>
        </div>
    ...
    <div class="text-center mt-8 sm:hidden">
        <a href="{{ route('discover') }}" class="btn-secondary">View All Cafes</a>
    </div>
</section>
...
<section class="bg-hearth-100/50 py-16 lg:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <p class="text-hearth-500 text-sm font-semibold uppercase tracking-wider mb-2">Fresh Discoveries</p>
            <h2 class="font-serif text-3xl md:text-4xl font-bold text-hearth-800">Recently Added</h2>
        </div>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
    <div class="bg-hearth-800 rounded-3xl overflow-hidden relative">
        ...
        <div class="relative px-8 py-16 md:px-16 md:py-20 text-center">
            <h2 class="font-serif text-3xl md:text-4xl font-bold text-white mb-4">Own a Cafe?</h2>
            <p class="text-hearth-200 text-lg mb-8 max-w-lg mx-auto">
                Join The Hearth community and showcase your cafe to thousands of coffee enthusiasts.
            </p>
