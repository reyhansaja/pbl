...
<head>
    ...
    <title>Verify OTP - CoffeSpot</title>
    ...
    <div class="min-h-screen flex">
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                <div class="mb-8">
                    <h1 class="font-serif text-3xl font-bold text-hearth-800 mb-2">Enter OTP</h1>
                ...
                <form method="POST" action="{{ route('password.otp.check') }}" class="space-y-5">
                    ...
                    <div>
                        <label for="otp" class="block text-xs font-semibold text-hearth-400 uppercase tracking-wider mb-2">OTP</label>
                    ...
                    <button type="submit" class="btn-primary w-full text-center">Verify OTP</button>
                </form>

                <p class="text-center text-sm text-hearth-400 mt-6">
                    <a href="{{ route('password.otp.request') }}" class="font-semibold text-hearth-600 hover:text-hearth-800">Resend OTP</a>
                </p>
            </div>
        </div>
    </div>
