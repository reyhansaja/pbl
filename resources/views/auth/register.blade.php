        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
            ...
            <div class="relative z-20 flex flex-col justify-between p-12 text-white">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('login') }}" class="text-sm font-semibold text-hearth-200 hover:text-white border border-hearth-400 px-4 py-2 rounded-lg transition-colors">Sign In</a>
                </div>
                <div class="max-w-md">
                    <p class="text-accent text-sm font-semibold uppercase tracking-wider mb-3">Welcome Artisan</p>
                    <h2 class="font-serif text-4xl font-bold leading-tight mb-4">"Pull up a chair. Stay as long as you like."</h2>
                    <p class="text-hearth-200 leading-relaxed">Join our digital corner of the world where discovery is personal and every corner has a story.</p>
                </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div class="lg:hidden flex items-center justify-between mb-8">
                    ...
                    <a href="{{ route('login') }}" class="text-sm font-semibold text-hearth-600 hover:text-hearth-800">Sign In</a>
                </div>

                <div class="mb-8">
                    <p class="text-xs font-semibold text-hearth-500 uppercase tracking-wider mb-2">Welcome Artisan</p>
                    <h1 class="font-serif text-3xl font-bold text-hearth-800">Create Your Account</h1>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div>
                        <label for="name" class="block text-xs font-semibold text-hearth-400 uppercase tracking-wider mb-2">Full Name</label>
                    ...
                    {{-- Role Toggle --}}
                    <div>
                        <label class="block text-xs font-semibold text-hearth-400 uppercase tracking-wider mb-3">Who are you?</label>
                    ...
                    <div>
                        <label for="password" class="block text-xs font-semibold text-hearth-400 uppercase tracking-wider mb-2">Secure Password</label>
                        <input id="password" type="password" name="password" required autocomplete="new-password"
                               class="input-field" placeholder="••••••••">
                        <p class="mt-1 text-xs text-hearth-300">Minimum 8 characters with the special strings.</p>
                        @error('password')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <p class="text-center text-sm text-hearth-400 mt-6">
                    Already have an account? <a href="{{ route('login') }}" class="font-semibold text-hearth-600 hover:text-hearth-800 transition-colors">Sign In</a>
                </p>
            </div>
        </div>
    </div>
